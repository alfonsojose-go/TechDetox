...
![Expo](https://img.shields.io/badge/Expo_SDK-49-black)
...
### Goal Setting
*Users set personalized screen-time goals by app category (social media, entertainment, productivity).* 

### Usage Dashboard
*Daily and weekly usage breakdowns with visual progress rings and trend indicators.*

### Mindful Notifications
*Gentle reminders when usage approaches daily limits, with breathing exercises and alternative activity suggestions.*
...
- **Focus mode** — Temporary blocking of distracting apps with customizable duration and break reminders
